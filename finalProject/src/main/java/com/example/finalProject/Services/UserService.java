...
import com.example.finalProject.mail.EmailSender;
...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) {
        ...
        boolean isEnabled = userRepository.findByEmail(email).get().getEnabled();
        if (!isEnabled) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"Email needs Validation");
        }
    ...
    public User register(User user) {
        ...
        String link="https://banqmisrproject.herokuapp.com/user/confirm/?token="+token;
